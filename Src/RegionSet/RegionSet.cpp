...
void RegionSet::UnitSet()
{
    for (int i = 0; i < data.GetLength(); i++)
    {
        ...
        {   
            ...
            double i_x0 = data[i].getPos().GetX();
            double i_y0 = data[i].getPos().GetY();
            double i_x1 = (data[i].getPos() + data[i].getSize()).GetX();
            double i_y1 = (data[i].getPos() + data[i].getSize()).GetY();

            double j_x0 = data[j].getPos().GetX();
            double j_y0 = data[j].getPos().GetY();
            double j_x1 = (data[j].getPos() + data[j].getSize()).GetX();
            double j_y1 = (data[j].getPos() + data[j].getSize()).GetY();
